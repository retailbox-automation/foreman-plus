...
- ⏳ pending external: (1) код кредитов $150 (форма подана 18.08, ≤72 бизнес-ч, redeem до 03.09) — чек: `gmail_imap.py search --account oskola7 --query 'SUBJECT "credit"' --days 4`; (2) billing quota increase (ответ на admin@, ~2 бизнес-дня). Дальше: ADK hello-fleet спайк → схема БД → флот.
